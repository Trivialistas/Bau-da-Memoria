const FilmesClassicos = [
    ...
    {"card1":"Titanic","card2":"------- é um filme sobre o naufrágio de um dos navios mais famosos da história","junto":"Titanic é um filme sobre o naufrágio de um dos navios mais famosos da história","total":"Um artista pobre chamado Jack Dawson e uma jovem rica chamada Rose DeWitt Bukater se conhecem e se apaixonam na fatídica jornada do Titanic, em 1912. Embora esteja noiva do arrogante herdeiro de uma siderúrgica, a jovem desafia sua família e amigos em busca do verdadeiro amor. O filme mostra e constroe seu romance até trágico fim onde o navio sofre um acidente e naufraga, levando à morte de várias pessoas incluindo Jack. No filme a história é narrada por Rose já velha que sobreviveu ao naufrágio."},
    {"card1":"O mágico de Oz","card2":"------- é um filme sobre uma garota que é levada para um mundo mágico onde conhece um espantalho, um leão e um homem de lata","junto":"O mágico de Oz é um filme sobre uma garota que é levada para um mundo mágico onde conhece um espantalho, um leão e um homem de lata","total":"Dorothy e seu cachorro Totó são levados para a terra mágica de Oz quando um ciclone passa pela fazenda de seus avós no Kansas. Eles viajam em direção à Cidade Esmeralda para encontrar o Mago Oz e no caminho encontram um Espantalho, que precisa de um cérebro, um Homem de Lata sem um coração e um Leão Covarde que quer coragem. O Mago pede ao grupo que tragam a vassoura da Bruxa Malvada do Oeste a fim de ganharem sua juda."},
    {"card1":"Cantando na Chuva","card2":"------- é uma comédia musical famosa pela cena de músca na chuva","junto":"Cantando na Chuva é uma comédia musical famosa pela cena de músca na chuva","total":"Don Lockwood e Lina Lamont são dois dos astros mais famosos da época do cinema mudo em Hollywood. Seus filmes são um verdadeiro sucesso e as revistas apostam num relacionamento mais íntimo entre os dois, o que não existe. Porém o cinema falado chega para mudar totalmente a situação de ambos no mundo da fama. Decidido a produzir um filme falado com o casal mais famoso do momento, Don e Lina precisam entretanto superar as dificuldades do novo método para conseguir manter a fama conquistada."},
    {"card1":"Tempos Modernos","card2":"------- é um filme do famoso Charlie Chaplin onde ele atua como um operário de uma fábrica","junto":"Tempos Modernos é um filme do famoso Charlie Chaplin onde ele atua como um operário de uma fábrica","total":"O icónico Vagabundo está empregado em uma fábrica, onde as máquinas inevitável e completamente o dominam e vários percalços o levam para a prisão. Entre suas passagens pela prisão, ele conhece e faz amizade com uma garota órfã. Ambos, juntos e separados, tentam lidar com as dificuldades da vida moderna, o Vagabundo trabalhando como garçom e, eventualmente, um artista."},
    {"card1":"Branca de Neve e os Sete Anões","card2":"------- é um famoso filme sobre uma princesa que é envenenada por uma bruxa ao comer uma maçã","junto":"Branca de Neve e os Sete Anões é um famoso filme sobre uma princesa que é envenenada por uma bruxa ao comer uma maçã","total":"A rainha malvada morre de ciúmes da beleza de Branca de Neve e manda mata-la. Logo, descobre que a jovem não morreu e está morando na floresta com sete amiguinhos. A princesa então é envenenada pela rainha e só o beijo de um príncipe pode salvá-la."},
    {"card1":"E o vento levou","card2":"------- é um filme que trata do relacionamento conturbado entre Scarlett O'Hara e Rhett Butler","junto":"E o vento levou é um filme que trata do relacionamento conturbado entre Scarlett O'Hara e Rhett Butler","total":"Scarlett O'Hara é uma jovem mimada que consegue tudo o que quer. No entanto, algo falta em sua vida: o amor de Ashley Wilkes, um nobre sulista que deve se casar com a sua prima Melanie. Tudo muda quando a Guerra Civil americana explode e Scarlett precisa lutar para sobreviver e manter a fazenda da família. Após Conhecer Rhett Butler seu relacionamento teve mutas idas e vindas, terminando o filme com os dois separados mas ela promete que reconquistará seu amor."},
    {"card1":"O poderoso chefão","card2":"------- é um filme que retrata o submundo da máfia","junto":"O poderoso chefão é um filme que retrata o submundo da máfia","total":"Don Corleone (Marlon Brando) é chefe de uma das famílias de mafiosos italianos mais respeitadas de Nova York. Quando ele é ferido e afastado de suas funções, o filho Michael (Al Pacino) deve tomar as rédeas da situação para acabar com o responsável e manter a honra do pai intacta. Dirigido por Francis Ford Coppola e vencedor de três Oscars, incluindo o de Melhor Filme."},
    {"card1":"Psicose","card2":"------- é um famoso filme de suspense sobre uma mulher que cometeu um crime e acaba indo parar num lugar chamado Motel Bates","junto":"Psicose é um famoso filme de suspense sobre uma mulher que cometeu um crime e acaba indo parar num lugar chamado Motel Bates","total":"Em Psicose, Marion Crane (Janet Leigh) é uma secretária que rouba 40 mil dólares da imobiliária onde trabalha para se casar e começar uma nova vida. Durante a fuga a carro, ela enfrenta uma forte tempestade, erra o caminho e chega em um velho hotel. O estabelecimento é administrado por um sujeito atencioso chamado Norman Bates (Anthony Perkins), que nutre um forte respeito e temor por sua mãe. Marion decide passar a noite no local, sem saber o perigo que a cerca."},

];

const EventosMarcantes = [
    
    {"card1":"1º Guerra Mundial","card2":"A ______ é popularmente conhecida como A Grande guerra, iniciou-se em 1914 ","junto":"A 1º guerra é popularmente conhecida como A Grande guerra, iniciou-se em 1914 ","total":"A Primeira Guerra Mundial, que durou de 1914 a 1918, foi considerada por muitos de seus contemporâneos como a mais terrível das guerras. Por este motivo, tornou-se conhecida durante muito tempo como “A Grande Guerra”. Se destacou pelo confronto entre a Tríplice Aliança (Alemanha, Áustria-Hungria e Itália) contra Tríplice Entente (Inglaterra, França e Rússia)."},
    {"card1":"2º Guerra Mundial","card2":"A ______ teve seu início oficial em 1939, a alemanha teve grande destaque nesse conflito ","junto":"A 2º guerra teve seu início oficial em 1939, a alemanha teve grande destaque nesse conflito ","total":"A Segunda Guerra Mundial estendeu-se de 1939 até 1945 e teve como estopim a invasão da Polônia pelos alemães em 1º de setembro de 1939. Os grupos que se enfrentaram na guerra foram os Aliados (Reino Unido, França, União Soviética e Estados Unidos) e o Eixo (Alemanha, Itália e Japão). Eventos mais famosos da segunda guerra: O Holocausto, o Massacre de Babi Yar e o lançamento das bombas atômicas sobre Hiroshima e Nagasaki."},
    {"card1":"Ditadura Brasileira","card2":"A _____ teve início em 1964 e durou 21 anos, um período bem marcante para o Brasil","junto":"A ditadura brasileira teve início em 1964 e durou 21 anos, um periodo bem marcante para o Brasil","total":"A ditadura militar no Brasil durou 21 anos (1964 e 1985), teve 5 mandatos militares e instituiu 16 atos institucionais (mecanismos legais que se sobrepunham à constituição). Nesse período houve restrição à liberdade, repressão aos opositores do regime e censura. Foi iniciada por um golpe civil-militar realizado em 1964, contra o então presidente João Goulart. Os militares passaram a impor um regime autoritário que era sustentado por tais atos institucionais."},
    {"card1":"República do Brasil","card2":"A _______ foi proclamada em 1889 a partir do golpe de Marechal Deodoro","junto":"A proclamação da república foi proclamada em 1889 a partir do golpe de Marechal Deodoro","total":"A Proclamação da República Brasileira aconteceu no dia 15 de novembro de 1889. Resultado de um levante político-militar que deu início à República Federativa Presidencialista. Fica marcada a figura de Marechal Deodoro da Fonseca como responsável pela efetiva proclamação e como primeiro Presidente da República brasileira em um governo provisório (1889-1891)."},
    {"card1":"Descobrimento do Brasil","card2":"O _______ tem sua data atribuída a 1500, por Pedro Alvares Cabral ","junto":"O descobrimento do Brasil tem sua data atribuída a 1500, por Pedro Alvares Cabral ","total":"O dia 22 de abril de 1500 marcou oficialmente a chegada dos portugueses ao território brasileiro, esse evento é muito conhecido como “descobrimento do Brasil”. A chegada dos portugueses aqui foi um dos momentos mais marcantes das grandes navegações, realizadas por eles durante todo o século XV. A partir desse acontecimento, a presença portuguesa no território foi constante, embora diminuta no início. A partir da década de 1530, medidas colonizatórias foram implantadas."},
    {"card1":"Independência do Brasil","card2":"A _______ teve sua data oficial em 1822, por D.Pedro II ","junto":"A independência do Brasil teve sua data oficial em 1822, por D.Pedro II ","total":"A independência do Brasil aconteceu em 1822, tendo como grande marco o grito da independência que foi realizado por Pedro de Alcântara (D. Pedro I durante o Primeiro Reinado), às margens do Rio Ipiranga, no dia 7 de setembro de 1822. Com a independência do Brasil declarada, o país transformou-se em uma monarquia com a coroação de D. Pedro I."},
